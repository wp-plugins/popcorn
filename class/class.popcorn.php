    ...
    public static function so_wp_ajax_function(){
        ...
        if (isset($_POST)){ 
            if($_POST['formtype'] == 'question'){
                ...
                $for_question = get_option('AQPD_question');
                if(get_option('AQPD_email')==''){
                   $send_to =  get_option( 'admin_email' );
                }else{
                    $send_to = get_option('AQPD_email');
                }
                $name = $_POST['uname'];
            ...
            <!-- // TODO Move style in css -->
                <div class='postbox-container' style='width: 99.5%'>
                    ...
                    <div class="em-menu-dashboard em-menu-group">
                        <div class="postbox popcorn-dashboard" style="padding : 15px !important;">
