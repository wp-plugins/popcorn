        ...
        <form id="form_4" action="" method="post">
            ...
            <p>
                ...
                <label class="disp_opt">
                    <input type='radio' name='CFPD_form_sel' id="sel_form_default" value="0" <?php if(get_option('CFPD_form_sel')==0) echo 'checked'; ?> />
                   <?php _e('Default Form' ,'popcorn');?>
                </label> &nbsp;&nbsp;&nbsp;&nbsp;
                <label>
                    <input type='radio' name='CFPD_form_sel' value="1" id="sel_form_custom" <?php if(get_option('CFPD_form_sel')==1) echo 'checked'; ?>/>
